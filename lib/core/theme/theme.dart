...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.light,
      primary: Color(0xff48285c),
      surfaceTint: Color(0xff735187),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff835f97),
      ...
      inverseSurface: Color(0xff332f35),
      inversePrimary: Color(0xffe0b8f5),
      primaryFixed: Color(0xff835f97),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff69477d),
      ...
      tertiaryFixedDim: Color(0xff76484a),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      inverseSurface: Color(0xff332f35),
      inversePrimary: Color(0xffe0b8f5),
      primaryFixed: Color(0xff5c3c70),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff442558),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff524458),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff3a2e41),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff693d3f),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff4f2729),
      onTertiaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      scrim: Color(0xff000000),
      inverseSurface: Color(0xffe9e0e7),
      inversePrimary: Color(0xff5b3a6f),
      primaryFixed: Color(0xfff4d9ff),
      onPrimaryFixed: Color(0xff200034),
      primaryFixedDim: Color(0xffe0b8f5),
      onPrimaryFixedVariant: Color(0xff48285c),
      secondaryFixed: Color(0xffefdcf5),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffdcb4f1),
